...
public class Schema_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Schema_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.fasterxml.jackson.databind.deser.std.ObjectArrayDeserializer$ArrayReferring",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, Schema_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, Schema_ESTest_scaffolding.class.getClassLoader()));
  }
